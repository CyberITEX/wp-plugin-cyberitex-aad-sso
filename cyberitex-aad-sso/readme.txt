...
Stable tag: 0.7.0
License: MIT
License URI: https://github.com/psignoret/microsoft-entra-wpconnect/blob/master/LICENSE.md
...
For more configuration information and bug reports, please visit [plugin's repo on GitHub](https://github.com/psignoret/microsoft-entra-wpconnect).
